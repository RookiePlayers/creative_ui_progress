                  ...
                  CreativeUIProgressBar(
                    options: CreativeUIProgressBarOptions(
                      ...
                      behavior: const CreativeUIProgressBarBehavior(
                        ...
                        maxValue: 100,
                        loopEnabled:
                            true, // loops 3 times, fires interval callback each time
                        playOnInit: true,
                      ),
                      callbacks: CreativeUIProgressBarCallbacks(
                        onCompletedInterval: () =>
                            debugPrint("Interval completed!"),
                        onFinalCompleted: (levelUp) =>
                            debugPrint("Finished looping, levelUp: $levelUp"),
                      ),
                    ),
                  ),
                ],
                  ...
                  CreativeUICircularProgress(
                    options: CreativeUICircularProgressOptions(
                      styles: CreativeUICircularProgressStyles(
                        size: 120,
                        strokeWidth: 14,
                        progressDecorationImage: NetworkImage(
                            "https://media.istockphoto.com/id/1490912792/vector/gradient-pride-colors-lgbtqia-rainbow-colors.jpg?s=612x612&w=0&k=20&c=wxAb1FCed3SzcDM2PIbFXskMW5hd85f-0ojlnRAEyB0="),
                        backgroundColor: Colors.black26,
                  ...
                  CreativeUICircularProgress(
                    options: CreativeUICircularProgressOptions(
                      ...
                      animation: const CreativeUICircularProgressAnimation(
                        ...
                        indeterminateSweepFraction: 0.35,
                        indeterminateMotion: IndeterminateMotion.ltr,
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () =>
                            circularController.play(value: 100, max: 100),
                        child: const Text("Play"),
                      ),
                      const SizedBox(width: 10),
                      ElevatedButton(
                        onPressed: () =>
                            circularController.reverse(toPercentage: 0),
                ...
                children: [
                  ...
                  CreativeUIArcProgress(
                    options: CreativeUIArcProgressOptions(
                      ...
                      animation: const CreativeUIArcProgressAnimation(
                        indeterminateMotion:
                            IndeterminateMotion.pingPong, // default
                        indeterminateRotationDuration:
